...
function pasarUsuarioAPremium(objetoMuchosUsuarios) {
   ...
   // Retornar el arreglo.
   // Tu código: 
//for (let usuario of objetoMuchosUsuarios) { //accedemos a usuario y a su propiedad esPremium y le damos el valor de true
...
function agregarMetodoCalculoDescuento(objetoProducto) {
   ...
   objetoProducto.calcularPrecioDescuento= function () {
    let val1= (objetoProducto.precio * objetoProducto.porcentajeDeDescuento) ;
    let val2= (objetoProducto.precio - val1);
    return val2;
   }
